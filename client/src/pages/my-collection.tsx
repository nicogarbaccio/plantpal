...
export default function MyCollection() {
  ...
  const filteredPlants = userPlants
    ? userPlants.filter(plant => {
        ...
        if (filter === "needs-water" && needsWaterPlants?.some(p => p.id === plant.id)) return true;
  ...
  const sortedPlants = [...filteredPlants].sort((a, b) => {
    ...
    if (sortBy === "next-water-date") {
      return new Date(a.nextWaterDate || 0).getTime() - new Date(b.nextWaterDate || 0).getTime();
    }
    ...
    <div className="bg-accent py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            <h2 className="text-2xl font-poppins font-semibold mb-2">My Plant Collection</h2>
            <p className="text-gray-600 font-lato">Manage and track the health of your plants</p>
          </div>
        ...
        <div className="bg-white rounded-[12px] shadow-md p-4 mb-8 flex flex-col md:flex-row justify-between">
          <div className="flex flex-wrap items-center gap-4 mb-4 md:mb-0">
            <Button 
              ...
              className={`px-4 py-2 ${filter === "all" ? "bg-primary text-white" : "bg-accent text-charcoal"} rounded-[12px] font-poppins`}
            ...
            <Button 
              ...
              className={`px-4 py-2 ${filter === "needs-water" ? "bg-primary text-white" : "bg-accent text-charcoal"} rounded-[12px] font-poppins`}
            ...
            <Button 
              ...
              className={`px-4 py-2 ${filter === "recently-added" ? "bg-primary text-white" : "bg-accent text-charcoal"} rounded-[12px] font-poppins`}
          ...
          <div className="flex items-center">
            <Select value={sortBy} onValueChange={setSortBy}>
              ...
              <SelectContent>
                <SelectItem value="last-watered">Sort by: Last Watered</SelectItem>
                <SelectItem value="name">Name</SelectItem>
                <SelectItem value="next-water-date">Next Water Date</SelectItem>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {isLoading ? (
            ...
            <div className="col-span-3 bg-white rounded-[12px] p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No plants in your collection</h3>
              <p className="text-gray-500 mb-6">Start adding plants to track their care schedule</p>
              <Link href="/my-collection/add">
